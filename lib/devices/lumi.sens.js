...
class XiaomiTempSensor extends ZigBeeDevice {
  ready() {
    ...
    this.subscribe(1, 'msTemperatureMeasurement', 'measuredValue', 60, 1, 1, this.handleTemperatureReport.bind(this))
    this.subscribe(1, 'msRelativeHumidity', 'measuredValue', 60, 1, 1, this.handleHumidityReport.bind(this))
