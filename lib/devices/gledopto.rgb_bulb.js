...
class GledoptoRgbBulb extends HomeKitDevice {
  ...
  onDeviceReady() {
    ...
    console.log(lightingColorCtrlAttrs)
    ...
    const color = this.getServiceCharacteristic('Bulb', 'Color')
    ...
    color.setProps({
      currentX: lightingColorCtrlAttrs.currentX,
      currentY: lightingColorCtrlAttrs.currentY,
    })
