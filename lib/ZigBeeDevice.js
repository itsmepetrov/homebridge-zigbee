...
class ZigBeeDevice {
  ...
  log(...args) {
    console.log(`${this.modelId} ${this.id}:`, ...args)
  }
  ...
  subscribe(endpointId, clusterId, attrId, repChange, minInt, maxInt, callback) {
    this.endpoint(endpointId).report(clusterId, attrId, repChange, minInt, maxInt)
